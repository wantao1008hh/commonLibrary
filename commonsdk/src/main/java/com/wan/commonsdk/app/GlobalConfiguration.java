...
import com.wan.commonsdk.BuildConfig;
import com.wan.commonsdk.mvp.model.api.Api;
import com.wan.commonsdk.util.SharedManager;
 ...
 * Created by MVPArmsTemplate on 12/05/2019 11:08
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        ResponseErrorListenerImpl responseErrorListener=new ResponseErrorListenerImpl();
...
//                })
                ...
                .formatPrinter(new FormatPrinter() {
                    ...
                    public void printJsonRequest(Request request, String bodyString) {
                        Timber.i("http:" + bodyString);
                    }

                    @Override
                    public void printFileRequest(Request request) {
                        Timber.i("http:" + request.url().toString());
                    }
